...
export class GatlingGun {
    ...
    fire(isFiring) {
        this.gunBarrel.rotation.z+=easeMotion(isFiring, 0.5, 0.005);
        this.fireBullets();
        if (isFiring) {
            this.addBullet();
        }
    ...
    rotate(isLeft, isRight) {
        this.gun.rotation.y+=easeMotion(isLeft, 3.5, 0.005);
        this.gun.rotation.y-=easeMotion(isRight, 3.5, 0.005);
    }
